...
function leftBtnClick() {
    ...
    if (selectedImage == 2) {
        ...
        productImage.src = "/Assets/Images/Product/Dart Holder/Image 1.webp";
        productImage.alt = "Dart Holder";
        selectedImage = 1;
    }
}
...
function rightBtnClick() {
    ...
    if (selectedImage == 1) {
        ...
        productImage.src = "/Assets/Images/Product/Dart Holder/Image 2.webp";
        productImage.alt = "Dart Holder";
        selectedImage = 2;
    }
}
...
async function submit() {
    ...
    formData.append("item", "Dart Holder");
