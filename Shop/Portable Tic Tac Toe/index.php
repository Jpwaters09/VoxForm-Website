...
<html lang="en-GB">
    <head>
        ...
        <meta name="twitter:image" content="https://voxform.co.uk/Assets/Images/Product/Portable%20Tic%20Tac%20Toe/Image%201.webp">
        ...
        <div id="content">
           <div id="images">
                ...
                <div id="imageSelector">
                    ...
                    <button onclick="imageBtn1()" id="image1Btn">1</button>
                    <button onclick="imageBtn2()" id="image2Btn">2</button>

                    <img onclick="rightBtnClick()" id="rightBtn" src="/Assets/Images/Forward.svg" alt="Right">
                </div>
            </div>
            <div id="info">
