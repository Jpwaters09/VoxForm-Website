...
<html lang="en-GB">
    <head>
        ...
        <link rel="canonical" href="https://voxform.co.uk/Quote/">
        <link rel="stylesheet" href="/Header/styles.css">
        <link rel="stylesheet" href="/Footer/styles.css">
        <script src="/Header/script.js" defer></script>
        <meta property="og:title" content="Quote | VoxForm">
        <meta property="og:description" content="Get a free quote for your custom 3D printing project. Upload your model file and we'll get back to you with a price.">
        <meta property="og:image" content="https://voxform.co.uk/Assets/Images/VoxForm-Logo.png">
        <meta property="og:url" content="https://voxform.co.uk/Quote/">
        <meta property="og:type" content="website">
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:image" content="https://voxform.co.uk/Assets/Images/VoxForm-Logo.png">
        <title>Quote | VoxForm</title>
        ...
        <script type="application/ld+json">
        {
            ...
            "description": "Get a free quote for your custom 3D printing project. Upload your model file and we'll get back to you with a price.",
            "areaServed": "GB",
            "url": "https://voxform.co.uk/Quote",
    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="form">
                <div id="left">
                    <span id="modelFileHeading">Model File</span>
                    <span id="modelFileDescription">Looking for a design? Find thousands of free 3D models on <a href="https://printables.com" target="_blank">Printables</a> — just download and upload below. Make sure the model allows commercial use before ordering.</span>
                    <div id="fileDiv">
                        <input onchange="addFile()" style="display: none;" type="file" id="filePickerInput" accept=".stl,.obj,.3mf,.step,.stp,.zip,model/stl,model/obj,application/zip,application/x-zip-compressed"></input>
                        <button onclick="document.getElementById('filePickerInput').click()" id="filePickerBtn">Add 3D Files</button>
                    ...
                    <span id="finishHeading">Finish</span>
                    <select id="finish">
                        <option value="" disabled selected>Select Finish</option>
                        <option value="Ironing">Ironing (Smooth, polished top surface)</option>
                        <option value="No Ironing">No Ironing (Standard finish)</option>
                    </select>

                    <span id="extraInfoHeading">Extra Info</span>
                    <textarea id="extraInfo" placeholder="Extra Info"></textarea>
                </div>
                ...
                <div id="right">
                    ...
                    <select id="shipping">
                        ...
                        <option value="RMT24">Royal Mail Tracked 24 - 1-2 days</option>
                        <option value="RMT48">Royal Mail Tracked 48 - 2-3 days</option>
                        <option value="YODEL">Yodel - 4-5 days</option>
                    </select>

                    <span id="nameHeading">Name</span>
                    <input type="text" id="nameInput" placeholder="Your Name">

                    <span id="emailHeading">Email</span>
                    <input type="email" id="emailInput" placeholder="Your Email">

                    <span id="phoneHeading">Phone Number</span>
                    <input type="tel" id="phoneInput" placeholder="Your Phone Number">

                    <span id="address1Heading">Address Line 1</span>
                    <input type="text" id="address1Input" placeholder="Address Line 1">

                    <span id="address2Heading">Address Line 2</span>
                    <input type="text" id="address2Input" placeholder="Address Line 2 (optional)">

                    <span id="cityHeading">City</span>
                    <input type="text" id="cityInput" placeholder="City">

                    <span id="countyHeading">County</span>
                    <input type="text" id="countyInput" placeholder="County">

                    <span id="postcodeHeading">Postcode</span>
                    <input type="text" id="postcodeInput" placeholder="Postcode">

                    <span id="countryHeading">Country</span>
                    <input type="text" id="countryInput" placeholder="County">
                    
                    <div id="socialMediaBox">
                        <input type="checkbox" id="socialMediaConsent">
                        <span id="socialMediaText">I'm happy for VoxForm to share photos and videos (including print timelapses) of my order on social media (Instagram, X, Facebook, etc.)</span>
                    </div>

                    <div id="legalBox">
                        <input type="checkbox" id="readLegalBox">
                        <span id="legalText">I have read and agree to the <a target="_blank" href="/Legal/">Legal Policies</a>, including our Terms & Conditions, Privacy Policy, and Returns & Refunds Policy.</span>
                    </div>
            ...
            <div id="placedPopup" style="display: none;">
                <span id="orderStatusHeading">Order Successfully Placed!</span>
                <span id="orderSucccesfulSubheading"></span>

                <span id="orderNumberText" style="display: none;">Your order number is:</span>
