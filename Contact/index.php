...
<html lang="en-GB">
    <head>
        ...
        <link rel="canonical" href="https://voxform.co.uk/Contact/">
    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="contactForm">
                ...
                <span id="emailHeader">Email</span>
                <input type="email" id="email" placeholder="Your Email">

                <span id="subjectHeader">Subject</span>
                <select id="subject">
                    <option value="General Enquiry">General Enquiry</option>
                    <option value="Order Query">Order Query</option>
                    <option value="Custom Print Question">Custom Print Question</option>
                    <option value="Feedback">Feedback</option>
                    <option value="Other">Other</option>
                </select>

                <span id="messageHeader">Message</span>
                <textarea id="message" placeholder="Your Message"></textarea>

                <button onclick="sendEmail()" id="sendBtn">Send Message</button>

                <span id="contactFormDescription">We aim to respond to all enquiries within 48 hours.</span>
            </div>
        </div>
